...
|===
+
image::idea-new-project-type.png[New Project - step 1,756,534,role="text-center"]
+
* Cliquer sur btn:[Next].
...
+
image::idea-new-project-location.png[New Project - step 2,756,169,role="text-center"]
+
* Cliquer sur btn:[Finish].
. L'espace de travail doit afficher une structure similaire suivante :
+
image::idea-created-project.png[Project has been created,679,296,role="text-center"]
